...
<form action="/savebmasuk" method="post" enctype="multipart/form-data">
  ...
  <div>
    ...
    <input type="date" class="form-control" id="tglf" name="tglf" placeholder="Masukan tanggal" value="{{old('tglf')}}">
    <div style=color:red>
      @error('tglf')
          {{$message}}
      @enderror
  ...
  <div>
    ...
    <select id="supplier_id" class="form-control" name="supplier_id" value="{{old('supplier_id')}}">
  ...
  <div>
    ...
    <input type="text" class="form-control" id="mharga" name="mharga" placeholder="Harga Barang" value="{{old('mharga')}}">
    <div style=color:red>
      @error('mharga')
          {{$message}}
      @enderror
  ...
  <div>
    ...
    <input type="text" class="form-control" id="mjumlah" name="mjumlah" placeholder="Jumlah Barang" value="{{old('mjumlah')}}">
    <div style=color:red>
          @error('mjumlah')
              {{$message}}
          @enderror
    ...
    <div>
        ...
        <input type="date" class="form-control" id="tgld" name="tgld" placeholder="tgld" value="{{old('tgld')}}">
        <div style=color:red>
          @error('tgld')
              {{$message}}
          @enderror
